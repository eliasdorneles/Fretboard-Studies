...
var CHORDGAME_SHELL_SHAPES = {
    maj7: [
        [{ s: 5, d: 0 }, { s: 3, d: 6 }, { s: 2, d: 8 }],
        [{ s: 4, d: 0 }, { s: 2, d: 6 }, { s: 1, d: 9 }],
        [{ s: 3, d: 0 }, { s: 1, d: 7 }, { s: 0, d: 9 }],
    ],
    min7: [
        [{ s: 5, d: 0 }, { s: 3, d: 5 }, { s: 2, d: 7 }],
        [{ s: 4, d: 0 }, { s: 2, d: 5 }, { s: 1, d: 8 }],
        [{ s: 3, d: 0 }, { s: 1, d: 6 }, { s: 0, d: 8 }],
    ],
    dom7: [
        [{ s: 5, d: 0 }, { s: 3, d: 6 }, { s: 2, d: 7 }],
        [{ s: 4, d: 0 }, { s: 2, d: 6 }, { s: 1, d: 8 }],
        [{ s: 3, d: 0 }, { s: 1, d: 7 }, { s: 0, d: 8 }],
    ],
    dim7: [
        [{ s: 5, d: 0 }, { s: 3, d: 5 }, { s: 2, d: 6 }],
        [{ s: 4, d: 0 }, { s: 2, d: 5 }, { s: 1, d: 7 }],
        [{ s: 3, d: 0 }, { s: 1, d: 6 }, { s: 0, d: 7 }],
    ],
    maj6: [
        [{ s: 5, d: 0 }, { s: 3, d: 6 }, { s: 2, d: 6 }],
        [{ s: 4, d: 0 }, { s: 2, d: 6 }, { s: 1, d: 7 }],
        [{ s: 3, d: 0 }, { s: 1, d: 7 }, { s: 0, d: 7 }],
    ],
};
